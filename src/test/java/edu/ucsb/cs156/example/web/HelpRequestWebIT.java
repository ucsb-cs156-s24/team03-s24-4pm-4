...
public class HelpRequestWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_helprequest() throws Exception {
        ...
        page.getByTestId("HelpRequestForm-requesterEmail").fill("email1");
        page.getByTestId("HelpRequestForm-teamId").fill("tid1");
        ...
        page.getByTestId("HelpRequestForm-explanation").fill("testing1");
        ...
        page.getByTestId("HelpRequestForm-requesterEmail").fill("email2");
        page.getByTestId("HelpRequestForm-submit").click();

        assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-requesterEmail")).hasText("email2");
