...
public class UCSBOrganizationWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_ucsborganization() throws Exception {
        ...
        page.getByTestId("UCSBOrganizationForm-orgCode").fill("TSSA");
        page.getByTestId("UCSBOrganizationForm-orgTranslationShort").fill("Turkish");
        page.getByTestId("UCSBOrganizationForm-orgTranslation").fill("TurkishStudent");
