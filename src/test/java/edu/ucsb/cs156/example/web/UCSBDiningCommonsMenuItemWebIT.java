...
public class UCSBDiningCommonsMenuItemWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_ucsbdiningcommonsmenuitem() throws Exception {
        ...
        page.getByTestId("UCSBDiningCommonsMenuItemForm-name").fill("Tacos");
        page.getByTestId("UCSBDiningCommonsMenuItemForm-station").fill("Mexican");
        ...
        page.getByTestId("UCSBDiningCommonsMenuItemForm-name").fill("Tortas");
        page.getByTestId("UCSBDiningCommonsMenuItemForm-submit").click();

        assertThat(page.getByTestId("UCSBDiningCommonsMenuItemTable-cell-row-0-col-name")).hasText("Tortas");
